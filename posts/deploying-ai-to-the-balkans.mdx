...
We live in uncertain times. Contradictory predictions emerge daily, from mass unemployment due to AI to the AI era being a bubble poised to pop in a dot-com fashion. Separating real signals from noise has become incredibly difficult. On one hand, some companies are freezing new hires or even laying off staff, believing that AI can do the job better, cheaper, and faster. On the other hand, [leading AI labs have begun outsourcing to cheaper markets to lower engineering costs](https://www.reuters.com/world/india/openai-launch-first-india-office-new-delhi-this-year-2025-08-22/). A surprising move when you would expect them to be the first to replace software engineers entirely.

Keeping up with useful information over the last three years has, at times, felt impossible. Less than 15 years ago, the idea of using neural networks to solve real-world problems sounded absurd. We have moved from "AI winters" to an era of AI proliferation. Artificial Intelligence has become mainstream: everyone, from the young to the old, uses LLMs in one way or another. The technology is now integrated into many products, and the promise of its future capabilities is even greater.

A book I have been reading lately, _[Boom](https://press.stripe.com/boom)_, argues that society has escaped stagnation and risk aversion only by inflating financial bubbles. For the authors, bubbles (often seen as destructive forces) have actually been crucial engines of innovation throughout history. The current AI economy, with its [immense data center costs](https://x.com/robertwiblin/status/1951248197881393235) and [a race to the bottom on per-token pricing](https://x.com/RihardJarc/status/1955640946856448232), doesn't make much sense. Anything can be a bubble until it bursts. If it pops, however, that says less about the technology itself and more about our perception of its capabilities. After all, 25 years later, the internet did not succumb to the dot-com bubble. As an interested party (being a software engineer), I have been trying to pay attention and look for signals that could confirm my fear that everything in AI right now is a bubble.

A few weeks ago, during my morning coffee, I opened Instagram and saw [several major accounts posting about Edi Rama](https://www.instagram.com/p/DNdpUFsI_Jk), the Prime Minister of Albania, claiming that Albania will have an AI-run Ministry sooner than we might think. While I was surprised by the news's virality, I didn't pay much attention to the posts, as they seemed like engagement farming. Later, I decided to check what was happening on Twitter and, to my surprise, [Rama appeared there as well](https://x.com/kos_data/status/1958572347906015336). I thought the algorithm must be playing with me, even though none of the content was from Albanian creators, who seemed largely unconcerned. I checked the news again, and [even Politico had published a piece on the topic](https://www.politico.eu/article/albania-use-ai-artificial-intelligenve-join-eu-corruption/). At that point, I reached my conclusion: this was the signal I had been waiting for, proof that we may be deep in the bubble.

Being so concerned about an economic issue when you don't have money in the game is a bit silly. It is a waste of time when I should be focusing on what is possible instead of worrying about what could be. This prompted me to think more deeply about what this meant for me, as someone connected to this discussion for two key reasons:
...
The technology required to identify an "anomaly" in a dataset, like fraudulent credit card usage or the corrupt use of funds, has been tackled for decades, most of the times without even needing neural networks. If we could build supervised tabular datasets, we could adopt simple and battle-tested approaches such as gradient boosting (_[XGBoost is all you need](https://www.xgblog.ai/p/xgboost-is-all-you-need)_).

This is to say that if we want to adopt statistical approaches to fight corruption at the decision-making stage (once all offers have been submitted), we don't have to wait until 2030. There is no need for AI like ChatGPT. In fact, we can do it now and have been able to for at least 15-20 years. The only thing we need is the commitment to gather the necessary data to build performant models.
...
A legitimate question arises: what do we optimize our AI Ministers for? For decades, the default metric to describe how countries are doing has been their GDP. You often see infographics on LinkedIn or Reddit comparing economic zones (e.g., "the Balkan countries' cumulative GDP is the same as..."). However, I believe that as a metric, it is very poor ([a view shared by many economists](https://www.scientificamerican.com/article/gdp-is-the-wrong-tool-for-measuring-what-matters/)). You can't effectively evaluate the Minister of the Environment's performance based on economic output. And if we choose poor objective functions, we risk ending up with even worse decision-makers than we currently have.

From a technological standpoint, we may not be there yet, but powerful techniques to "fine-tune" (that is, improve for specific tasks) existing models have emerged in the last couple of years. Group Relative Policy Optimization (GRPO), for instance, is a reinforcement learning algorithm that allows us to "educate" our models by giving them a reward when they behave as expected. We place them in front of various choices, "rewarding" them when they do well and "punishing" them when they do poorly. Imagine a "Doctor Strange" AI model that could envision and learn from every possible near-future scenario to optimize its decision-making. I don't see this as an unforeseeable future.

Reinforcement learning algorithms like GRPO have proven to be a great approach for specializing AI in specific tasks like coding or math. The primary limitation we currently face in adopting them for more general tasks is that they are data-hungry, requiring environments from which they can continuously learn. For example, [major AI labs compete to see which model can finish Pokémon games faster](https://x.com/Clad3815/status/1955980772575268897), with the Pokémon world serving as the environment. We can't realistically create an environment to train an AI for the role of a Minister of Defense (_[or War](https://www.whitehouse.gov/presidential-actions/2025/09/restoring-the-united-states-department-of-war/)_), as the required environment would be the entirety of society, or better yet, the whole world and its dynamics.
...
Until now, I have focused on the possibilities of AI. However, the time has come to consider the current state and limitations of these tools. I'd like to explore this fictitiously, through the lens of Balkan dynamics. Again, purely as an "intellectual game."
