...
The AI did not choose random locations to build Albanian schools. The Presheva Valley has a population that is [over 90% ethnically Albanian](https://en.wikipedia.org/wiki/Pre%C5%A1evo_Valley#Demographics), while Skopje is home to [more than one hundred thousand ethnic Albanian citizens](https://en.wikipedia.org/wiki/Skopje#Demographics). Moreover, do you recall its oath to the constitution? _[Article 8](https://www.gjk.gov.al/web/constitution_of_albania_1722.pdf)_ of the Albanian Constitution states:
